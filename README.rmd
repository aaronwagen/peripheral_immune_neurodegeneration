...
| --------- | --------------------------------------------------------------------------- |
| [docs](docs) | Contains all `.Rmd`s and their corresponding `.html`s describing analyses performed for this project. These can be view interactively at: [https://aaronwagen.github.io/peripheral_immune_neurodegeneration/](https://aaronwagen.github.io/peripheral_immune_neurodegeneration/)|
...
This package makes use of the [coloc package, version 5.1.0.1](https://cran.r-project.org/package=coloc), as well as wrapper functions found in [colochelper version 0.99.1](http://dx.doi.org/10.5281/zenodo.5011869).
