...
enrichment_expression <- enrichment_histogram_data %>% 
    ...
    annotate("text", x = -Inf,  y = 0.99 * max(median_data$max_density),
             hjust = 0,
             label = "p-value < 0.001",
             colour = "indianred4", size = 4) +
    annotate("text", x = -Inf,  y = 0.92 * max(median_data$max_density),
             label = "p-value < 0.001",
              hjust = 0,
...
source("r_scripts/opentargets_chen_bootstrap_parallelised.R")
```
