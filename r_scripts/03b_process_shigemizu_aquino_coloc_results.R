...
# sbatch --time=4:00:00 --output logs/coloc_shigemizu_aquino_processing.log --open-mode=truncate --mem=36G --wrap="Rscript r_scripts/03l_process_shigemizu_aquino_coloc_results.R"
...
# Set path
here::i_am("r_scripts/03l_process_shigemizu_aquino_coloc_results.R")
