...
# sbatch --time=6:00:00 --output logs/coloc_foo_aquino_processing.log --open-mode=truncate --mem=64G --wrap="Rscript r_scripts/03g_process_foo_aquino_coloc_results.R"
...
# Set path
here::i_am("r_scripts/03g_process_foo_aquino_coloc_results.R")
