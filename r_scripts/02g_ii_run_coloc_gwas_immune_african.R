...
# sbatch --time=3-00:00:00 --output logs/coloc_rizig2023_nedelecquach_ii.log --open-mode=truncate --mem=64G --wrap="Rscript r_scripts/02c_ii_run_coloc_gwas_immune_african.R"
...
for(eqtl_number in 5:nrow(eqtl_metadata)) {
