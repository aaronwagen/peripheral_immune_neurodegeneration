...
# Assign arguments
args <- list(
  gwas_name = "jansen_2019",
  munged_gwas = file.path(base_dir, "raw_data/GWAS/coloc_munged_data/jansen2019_gwas_tidy_varbeta.txt"),
  ...
  ensembl_gene_ids_overlapping_1Mb_window_hit_path =  file.path(base_dir, 
                                                                "raw_data",
                                                                 "GWAS/coloc_munged_data/jansen_ensembl_gene_ids_overlapping_1Mb_window_hit.RDS"),
