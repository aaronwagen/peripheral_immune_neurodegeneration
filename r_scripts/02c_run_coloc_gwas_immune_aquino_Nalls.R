...
# Assign arguments
args <- list(
  gwas_name = "PD2019_ex23andMe",
  gwas_dir = "/camp/lab/gandhis/home/shared/LDSC/GWAS/PD2019_meta5_ex23andMe/",
  ...
  output_path = here::here("processed_data",
                           "nalls_aquino_2018",
                           "coloc"),
  gwas_results_path = here::here("/nemo/lab/gandhis/home/users/wagena/references/GWAS/"),
  PD_gwas_details = list(n_cases = 33674, 
                         n_controls = 449056, 
                         cc_or_quant = "cc", 
                         n_total = 482730, 
                         prop_cases = 0.074989),
  ensembl_gene_ids_overlapping_1Mb_window_hit_path =  here::here("raw_data",
                                                                 "ensembl_genes_within_1Mb_window_Nalls_PD_GWAS_hit.RDS"),
...
ensembl_gene_names_to_test_nalls  <- readRDS(file = args$ensembl_gene_ids_overlapping_1Mb_window_hit_path)  
