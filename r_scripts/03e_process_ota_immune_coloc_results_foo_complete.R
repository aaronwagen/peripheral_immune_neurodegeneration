#
# Title: "Analyse colocalisation of peripheral immune-cell genes and PD GWAS risk in the Foo et al Asian PD GWAS "
# Author: "Aaron Wagen"
...
# Set path
here::i_am("r_scripts/03b_process_ota_immune_coloc_results_foo_complete.R")
...
args <- list(
  ...
  coloc_results_summary_file = here::here("processed_data",
                                          ...
                                          "coloc",
                                          "coloc_summary.Rds"),
  gencode_v27_gtf = "/camp/home/wagena/references/GRCh38/annotation/gencode.v27.annotation.gtf.gz"
...
gtf <- rtracklayer::readGFF(args$gencode_v27_gtf) %>% 
  as_tibble() %>% 
