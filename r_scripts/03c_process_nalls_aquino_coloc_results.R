...
# sbatch --time=12:00:00 --output logs/coloc_nalls_aquino_processing.log --open-mode=truncate --mem=64G --wrap="Rscript r_scripts/03f_process_nalls_aquino_coloc_results.R"
...
# Set path
here::i_am("r_scripts/03f_process_nalls_aquino_coloc_results.R")
