#
# Title: "Analyse colocalisation of peripheral immune-cell genes and PD GWAS risk in the rizig_aquino gwas"
# Author: "Aaron Wagen"
...
# sbatch --time=6:00:00 --output logs/coloc_rizig_aquino_processing.log --open-mode=truncate --mem=64G --wrap="Rscript r_scripts/03i_process_rizig_aquino_coloc_results.R"
...
# Set path
here::i_am("r_scripts/03i_process_rizig_aquino_coloc_results.R")
